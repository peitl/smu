...
gtools : copyg listg labelg dretog amtog geng complg showg NRswitchg \
  ...
  genspecialg edgetransg genbgL shortg genprop genf ;
...
genprop : ${GTOOLSH} genprop.c gtoolsW.o nautyW1.o nautilW1.o naugraphW1.o \
	    schreierW.o naurng.o
	${CC} -o genprop ${CFLAGS} ${W1} genprop.c gtoolsW.o schreierW.o \
		nautyW1.o nautilW1.o naugraphW1.o naurng.o ${LDFLAGS} -lcryptominisat5

genf : ${GTOOLSH} genf.c gtoolsW.o nautyW1.o nautilW1.o naugraphW1.o \
	    schreierW.o naurng.o
	${CC} -o genf ${CFLAGS} ${W1} genf.c gtoolsW.o schreierW.o \
		nautyW1.o nautilW1.o naugraphW1.o naurng.o ${LDFLAGS}
